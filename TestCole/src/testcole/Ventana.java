...
public class Ventana extends JFrame implements ActionListener{
    ...
    public boolean guardarDesdeEditar=false;
       ...
       guardarBt=new JButton("Guardar");
        ...
        guardarAlumnoBt.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                boolean cambiaCurso=false;
                
                if(alumnos.get(alumno).getCurso()!=Integer.valueOf(cursoEditarTf.getText())){
                    cambiaCurso=true;
                }
